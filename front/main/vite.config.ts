  ...
  return {
    ...
    plugins: [
      ...
      federation({
        name: "front-main",
        remotes: {
          'front-home': process.env.VITE_FRONT_HOME_URL + 'dist/assets/front-home.js',
          'front-match-score': process.env.VITE_FRONT_MATCH_URL + 'dist/assets/front-match-score.js',
          'front-tournament': process.env.VITE_FRONT_TOURNAMENT_URL + 'dist/assets/front-tournament.js',
          'front-backoffice': process.env.VITE_FRONT_BO_URL + 'dist/assets/front-backoffice.js'
        },
